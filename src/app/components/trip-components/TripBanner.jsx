export default function TripBanner({tripBannerDetails}) {
  // console.log('tripBannerDetails', tripBannerDetails);
    ...
    >
      ...
      >
        <div className="container col rounded-top text-center p-2">
          <p className="m-0 text-2xl font-bold ">{tripBannerDetails.tripName}</p>
        ...
        <div className="bg-white p-2 ">
          <div className="columns-1 flex flex-row flex-wrap align-items-end">
            <p id="tripDest" className="align-self-end my-0 fs-6">
              Destination: {tripBannerDetails.destination ? tripBannerDetails.destination : 'N/A'}
            </p>
          </div>
          ...
          <div className="column-1 flex flex-row flex-wrap align-items-end border-bottom">
            <p id="tripAdd" className="align-self-end my-0 fs-6">
              Address: {tripBannerDetails.address ? tripBannerDetails.address : 'N/A'}
            </p>
          </div>
          ...
          >
            <div className="w-full flex flex-row p-0">
              <h5 className="align-self-baseline me-2 mb-0 fs-6">Travelers: {tripBannerDetails.guests ? tripBannerDetails.guests : 'N/A'}</h5>
            </div>

            <div className="w-full flex flex-row p-0">
              <h5 className="align-self-baseline me-2 mb-0 fs-6">Reason: {tripBannerDetails.reason ? tripBannerDetails.reason : 'N/A'}</h5>
            </div>

            <div className="w-full flex flex-row p-0">
              <h5 className="align-self-baseline me-2 mb-0 fs-6">
                Transportation: {tripBannerDetails.transportation ? tripBannerDetails.transportation : 'N/A'}
              </h5>
            </div>
          </div>
        </div>
